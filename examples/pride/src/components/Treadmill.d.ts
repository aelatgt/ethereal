...
export default class Treadmill {
    ...
    state: {
        ...
        is(stateMap: import("../lib/AdaptiveProperty").AdaptivePropertyStateMap<Treadmill>): boolean;
        changingTo(stateMap: import("../lib/AdaptiveProperty").AdaptivePropertyStateMap<Treadmill>): boolean;
        changingFrom(stateMap: import("../lib/AdaptiveProperty").AdaptivePropertyStateMap<Treadmill>): boolean;
    };
