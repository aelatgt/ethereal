...
import { LocalPositionConstraint, LocalOrientationConstraint, LocalScaleConstraint, AspectConstraint, SpatialBoundsConstraint, VisualBoundsConstraint, VisualMaximizeObjective, SpatialObjective } from './SpatialObjective';
...
export class SpatialLayout {
    constructor(adapter) {
        ...
        this.spatialAccuracy = '10mm';
        this.visualAccuracy = '1px';
        this.angularAccuracy = '0.1deg';
        this.relativeAccuracy = 0.02;
        this.successRate = 0;
        this.restartRate = 0;
        /**
        ...
        this.compareSolutions = (a, b) => {
            ...
            if (a.scores.length < objectives.length)
                return 1;
    ...
    */
     ...
     */
    spatialOrientation(spec, opts) {
        return this.localOrientation(spec, opts);
    }
    spatialBounds(spec, opts) {
...
export class LayoutSolution {
    ...
    perturb() {
        ...
        if (strategyType === 'rotate') {
            const orientationSpec = this.layout.localOrientationConstraint?.spec;
    ...
    _perturbFromSpatialBoundsSpec(value, stepSize, spec, sType) {
        if (spec === undefined)
