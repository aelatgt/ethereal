...
export class WebRenderer {
    ...
    static _init() {
        ...
        addCSSRule(sheet, `[${WebRenderer.RENDERING_INLINE_ATTRIBUTE}]`, 'top: var(--x-inline-top) !important; width:auto !important', i++);
        addCSSRule(sheet, `[${WebRenderer.RENDERING_PARENT_ATTRIBUTE}]`, 'transform: none !important; left: 0 !important; top: 0 !important; margin: 0 !important; border:0 !important; border-radius:0 !important; height:100% !important; padding:0 !important; position:static !important; text-align:left !important; display:block !important; background: rgba(0,0,0,0) none !important; box-shadow:none !important', i++);
        addCSSRule(sheet, `[${WebRenderer.RENDERING_PARENT_ATTRIBUTE}]::before, [${WebRenderer.RENDERING_PARENT_ATTRIBUTE}]::after`, 'content:none !important; box-shadow:none !important;', i++);
        let previousHash = '';
        const onHashChange = () => {
