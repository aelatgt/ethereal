...
Object3D.prototype.updateMatrix = function(this:THREE.Object3D) {
    ...
    this.matrix.compose(position, quaternion, _s)
}
...
Object3D.prototype.updateWorldMatrix = function(this:THREE.Object3D, updateParents:boolean, updateChildren:boolean, updateLayout=true) {
    ...
    if ( updateLayout === false && this.layout.isBoundingContext() ) return
    ...
    if ( updateLayout === true ) {
        ...
        updateChildren && this.layout.updateMatrix() // only update layout matrix after updating children
